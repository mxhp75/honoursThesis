...
# Volcano plots for visualisation of differential expression
...
d2$threshold <- 0
d2$threshold[1:nrow(topTable)] <- 1
...
## Use this plot when looking at fetal sex differences - otherwise comment out.##
