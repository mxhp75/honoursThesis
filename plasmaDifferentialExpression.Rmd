...
After filtering out the counts noise (sequence counts with low confidence) we are left with 1453 unique miRNAs.
...
# remove lowly expressed genes logical eg cpm >1 in >=20 samples (7 samples in the smallest group)
