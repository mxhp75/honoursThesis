...
mirbase <- mirbase_db[,7] %>%
  ...
  subset(., Name %in% c("hsa-miR-517a-3p", "hsa-miR-518a-3p", "hsa-miR-518b", "hsa-miR-518c-3p", "hsa-miR-1323", "hsa-miR-498", "hsa-miR-512-3p", "hsa-miR-515-5p", "hsa-miR-517a-5p", "hsa-miR-517c-3p", "hsa-miR-518a-5p", "hsa-miR-518c-5p", "hsa-miR-518e-3p", "hsa-miR-518e-5p", "hsa-miR-519a-3p", "hsa-miR-519a-5p", "hsa-miR-519d-3p", "hsa-miR-519d-5p", "hsa-miR-520a-3p", "hsa-miR-520a-5p", "hsa-miR-525-3p", "hsa-miR-525-5p", "hsa-miR-526a", "hsa-miR-526b-3p", "hsa-miR-526b-5p")) %>%
  arrange(., Name)
...
allC19MC_placenta <- as.data.frame(allC19MC_placenta) 
allC19MC_placenta$rowname <- rownames(allC19MC_placenta) %>%
  as.data.frame()
